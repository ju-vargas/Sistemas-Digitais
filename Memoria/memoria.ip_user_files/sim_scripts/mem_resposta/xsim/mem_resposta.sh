...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L secureip -L xpm --snapshot mem_resposta xil_defaultlib.mem_resposta -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  mem_resposta -key {Behavioral:sim_1:Functional:mem_resposta} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mem_resposta.wdb xsim.dir)

...
HD_PWD='C:/Users/aluno/Desktop/SD/estados/estados.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_process.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_process.tcl

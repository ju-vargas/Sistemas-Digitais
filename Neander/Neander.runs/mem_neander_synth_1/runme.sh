...
HD_PWD='/media/juliana/LinFiles/Documents/GitHub/Sistemas-Digitais/Neander/Neander.runs/mem_neander_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_neander.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mem_neander.tcl

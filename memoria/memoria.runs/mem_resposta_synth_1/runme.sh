...
HD_PWD='C:/Users/aluno/Desktop/SD/Sistemas-Digitais/memoria/memoria.runs/mem_resposta_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_resposta.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_resposta.tcl

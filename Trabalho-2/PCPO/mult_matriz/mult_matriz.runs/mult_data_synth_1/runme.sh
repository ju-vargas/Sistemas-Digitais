...
HD_PWD='/media/juliana/LinFiles/Documents/GitHub/Sistemas-Digitais/Trabalho-2/PCPO/mult_matriz/mult_matriz.runs/mult_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_data.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mult_data.tcl

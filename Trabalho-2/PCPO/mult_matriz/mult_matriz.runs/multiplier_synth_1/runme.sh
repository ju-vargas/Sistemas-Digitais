...
HD_PWD='/media/juliana/LinFiles/Documents/GitHub/Sistemas-Digitais/Trabalho-2/PCPO/mult_matriz/mult_matriz.runs/multiplier_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier.vds -m64 -mode batch -messageDb vivado.pb -notrace -source multiplier.tcl

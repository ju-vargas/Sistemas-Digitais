...
# executing this script. Please type 'mult_data.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key mult_data_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc mult_data_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../mult_matriz.srcs/sources_1/ip/mult_data/sim/mult_data.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.mult_data -o mult_data_simv
}
...
simulate()
{
  ...
  ./mult_data_simv $opts -do simulate.do
}
# Script usage
usage()
{

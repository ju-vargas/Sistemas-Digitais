...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../mult_matriz.srcs/sources_1/ip/multiplier/sim/multiplier.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.multiplier $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.multiplier -input simulate.do
}
# Script usage
usage()
{

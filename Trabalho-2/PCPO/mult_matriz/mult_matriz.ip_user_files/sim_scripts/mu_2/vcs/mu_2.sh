...
# executing this script. Please type 'mu_2.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key mu_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc mu_2_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../mult_matriz.srcs/sources_1/ip/mu_2/sim/mu_2.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.mu_2 -o mu_2_simv
}

...
#
# Script generated by Vivado on Mon Feb 19 21:43:14 -0300 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : matrixmul_0.sh
...
#
# Usage        : matrixmul_0.sh
#                matrixmul_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                matrixmul_0.sh [-reset_run]
#                matrixmul_0.sh [-reset_log]
#                matrixmul_0.sh [-help]
#
...
# script info
echo -e "matrixmul_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./matrixmul_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot matrixmul_0 xil_defaultlib.matrixmul_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim matrixmul_0 -key {Behavioral:sim_1:Functional:matrixmul_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb matrixmul_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./matrixmul_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: matrixmul_0.sh [-help]\n\
Usage: matrixmul_0.sh [-step]\n\
Usage: matrixmul_0.sh [-lib_map_path]\n\
Usage: matrixmul_0.sh [-reset_run]\n\
Usage: matrixmul_0.sh [-reset_log]\n\
Usage: matrixmul_0.sh [-keep_index]\n\
Usage: matrixmul_0.sh [-noclean_files]\n\n\

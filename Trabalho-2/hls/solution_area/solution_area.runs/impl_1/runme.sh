...
HD_PWD='D:/Sistemas-Digitais/Trabalho-2/hls/solution_area/solution_area.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_mul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source matrix_mul.tcl -notrace

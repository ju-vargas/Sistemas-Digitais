...
HD_PWD='D:/Sistemas-Digitais/Trabalho-2/hls/solution_area/solution_area.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_mul.tcl

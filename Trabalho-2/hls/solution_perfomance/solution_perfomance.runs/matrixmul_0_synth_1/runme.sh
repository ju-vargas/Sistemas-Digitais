...
HD_PWD='D:/Sistemas-Digitais/Trabalho-2/hls/solution_perfomance/solution_perfomance.runs/matrixmul_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrixmul_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrixmul_0.tcl

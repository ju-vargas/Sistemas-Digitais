...
HD_PWD='D:/Sistemas-Digitais/Trabalho-2/hls/solution_perfomance/solution_perfomance.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log solution_perfomance.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source solution_perfomance.tcl -notrace

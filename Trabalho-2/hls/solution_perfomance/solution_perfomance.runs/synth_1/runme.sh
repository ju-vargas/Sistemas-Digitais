...
HD_PWD='D:/Sistemas-Digitais/Trabalho-2/hls/solution_perfomance/solution_perfomance.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solution_perfomance.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solution_perfomance.tcl

...
using hls::sim::Byte;
extern "C" void matrixmul(Byte<1>*, Byte<1>*, Byte<1>*);
extern "C" void apatb_matrixmul_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_r) {
...
std::vector<Byte<1>> __xlx_r__tmp_vec;
for (size_t i = 0; i < 4; ++i){
__xlx_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_r)[i]);
}
  int __xlx_size_param_r = 4;
  int __xlx_offset_param_r = 0;
  int __xlx_offset_byte_param_r = 0*1;
  // DUT call
  matrixmul(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_r__tmp_vec.data());
...
((Byte<1>*)__xlx_apatb_param_r)[i] = __xlx_r__tmp_vec[__xlx_offset_param_r+i];
}
}

...
HLS_SOURCES = ../../../../matrixmul_test.cpp ../../../../matrixmul_test2.cpp ../../../../matrixmul.cpp
...
$(ObjDir)/matrixmul_test2.o: ../../../../matrixmul_test2.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../matrixmul_test2.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/matrixmul_test2.d

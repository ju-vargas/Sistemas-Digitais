set moduleName matrixmul_Pipeline_Row_a01_sum01
set isTopModule 0
...
set C_modelName {matrixmul_Pipeline_Row_a01_sum01}
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 6 }  { a_ce0 mem_ce 1 1 }  { a_q0 in_data 0 8 } } }

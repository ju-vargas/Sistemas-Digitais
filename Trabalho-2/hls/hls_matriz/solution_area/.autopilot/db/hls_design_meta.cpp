...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("r_address0", 2, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("r_ce0", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("r_we0", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("r_d0", 8, hls_out, 2, "ap_memory", "mem_din", 1),
};

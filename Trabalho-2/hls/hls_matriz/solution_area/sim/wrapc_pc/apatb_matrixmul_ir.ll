; ModuleID = 'D:/Sistemas-Digitais/Trabalho-2/hls/hls_matriz/solution_area/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_matrixmul_ir([8 x i8]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="8" %a, [2 x i8]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="2" %b, [2 x i8]* noalias nocapture nonnull "fpga.decayed.dim.hint"="2" %r) local_unnamed_addr #0 {
entry:
  %a_copy = alloca [8 x [8 x i8]], align 512
  %b_copy = alloca [2 x [2 x i8]], align 512
  %r_copy = alloca [2 x [2 x i8]], align 512
  %0 = bitcast [8 x i8]* %a to [8 x [8 x i8]]*
  %1 = bitcast [2 x i8]* %b to [2 x [2 x i8]]*
  %2 = bitcast [2 x i8]* %r to [2 x [2 x i8]]*
  call fastcc void @copy_in([8 x [8 x i8]]* nonnull %0, [8 x [8 x i8]]* nonnull align 512 %a_copy, [2 x [2 x i8]]* nonnull %1, [2 x [2 x i8]]* nonnull align 512 %b_copy, [2 x [2 x i8]]* nonnull %2, [2 x [2 x i8]]* nonnull align 512 %r_copy)
  call void @apatb_matrixmul_hw([8 x [8 x i8]]* %a_copy, [2 x [2 x i8]]* %b_copy, [2 x [2 x i8]]* %r_copy)
  call void @copy_back([8 x [8 x i8]]* %0, [8 x [8 x i8]]* %a_copy, [2 x [2 x i8]]* %1, [2 x [2 x i8]]* %b_copy, [2 x [2 x i8]]* %2, [2 x [2 x i8]]* %r_copy)
  ret void
}
